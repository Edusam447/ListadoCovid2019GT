...
public class ArbolBinario {
    ...
    public static void AgregarNodo(String n, String d, String m, String lv, double dpi, int cDosis, int dVacuna1, int dVacuna2, int dVacuna3){
    ...
    public NodoPersona ObtenerNodoReemplazo(NodoPersona nodoreemp){
        ...
        System.out.println("El nodo Reemplazo es: " + reemplazo.getNombre() + ", DPI: " +reemplazo.getDpi());
        return reemplazo;
    }
